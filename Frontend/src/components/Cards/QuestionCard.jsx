        ...
        <div className='flex items-start justify-between cursor-pointer'>
            ...
            <div className='flex items-center justify-end ml-4 relative'>
                <div className={`flex ${isExpanded?"md:flex":"md:hidden group-hover:flex"}`}>
                    ...
                    <button className='flex items-center gap-2 text-xs text-indigo-800 font-medium bg-cyan-50 px-3 py-1 mr-2 rounded text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer' onClick={()=>{
                        setisExpanded(true)
                        onLearnMore()
                    }}>
                        <LuSparkles/>
